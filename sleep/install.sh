	...
	<array>
		<dict>
			...
			<dict>
				...
				<dict>
					<key>COMMAND_STRING</key>
					<string>osascript -e 'tell application "System Events" to sleep'</string>
					<key>CheckedForUserDefaultShell</key>
					<true/>
					<key>inputMethod</key>
					<integer>0</integer>
...
echo "  3. Double-click the shortcut area and press your desired key combo (e.g. Ctrl+Option+S)"
